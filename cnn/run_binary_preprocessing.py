...
try:
    if download_data:
        if onlytesting:
            ...
            subprocess.call(
                f'python utils/get_data.py -sd {testing_start_date} -ed {testing_end_date} -t {symbol} -s yahoo -p testing',
                shell=True)
        ...
        if onlytraining:
            ...
            subprocess.call(
                f'python utils/get_data.py -sd {training_start_date} -ed {training_end_date} -t {symbol} -s yahoo -p training',
                shell=True)
...
try:
    if createLabel:
        if onlytraining:
            ...
            subprocess.call(
                f'python preproccess_binclass.py -m createLabel -l {windows_length} -i stockdatas/{symbol}_training.csv',
                shell=True)
        ...
        if onlytesting:
            ...
            subprocess.call(
                f'python preproccess_binclass.py -m createLabel -l {windows_length} -i stockdatas/{symbol}_testing.csv',
                shell=True)
...
try:
    if createOhlc2cs:
        ...
        if onlytesting:
            ...
            subprocess.call(
                f'python preproccess_binclass.py -m ohlc2cs -l {windows_length} -i stockdatas/{symbol}_testing.csv -t testing -d {dimension} -v {use_volume}',
                shell=True)
...
try:
    if onlytraining:
        ...
        print(
            f'python preproccess_binclass.py -m img2dt -i dataset/{windows_length}_{dimension}/{symbol}/training -lf ./label/{symbol}_training_label_{windows_length}.txt')
        subprocess.call(
            f'python preproccess_binclass.py -m img2dt -i dataset/{windows_length}_{dimension}/{symbol}/training -lf ./label/{symbol}_training_label_{windows_length}.txt',
            shell=True)
    ...
    if onlytesting:
        ...
        subprocess.call(
            f'python preproccess_binclass.py -m img2dt -i dataset/{windows_length}_{dimension}/{symbol}/testing -lf ./label/{symbol}_testing_label_{windows_length}.txt',
            shell=True)
